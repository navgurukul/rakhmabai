  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        responseMap["signature"] = signature;
        responseMap["orderTotalAmount"] = orderTotalAmount;
        responseMap["sellerOrderId"] = sellerOrderId;
        responseMap["orderTotalCurrencyCode"] = orderTotalCurrencyCode;
        responseMap["amazonOrderId"] = amazonOrderId;
        responseMap["description"] = description;
        responseMap["reasonCode"] = reasonCode;
        responseMap["transactionDate"] = transactionDate;
        responseMap["status"] = status;

        // const requestParameters = new URLSearchParams(request.query.URL);
        ...
        // responseMap["orderTotalCurrencyCode"] = requestParameters.get(
        //   "orderTotalCurrencyCode"
        // );
        // responseMap["amazonOrderId"] = requestParameters.get("amazonOrderId");
        // responseMap["description"] = requestParameters.get("description");
        // responseMap["reasonCode"] = requestParameters.get("reasonCode");
        // responseMap["transactionDate"] = requestParameters.get(
        //   "transactionDate"
        // );
        // responseMap["status"] = requestParameters.get("status");
